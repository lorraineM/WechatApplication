...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="main-container">
			...
			<div class="second-div d-w-990 z-1">
				<div class="grid-25">
					...
					<div class="btns" id="address_btn_s" name="address_btn_s" style="margin-top:20px">
						<a onclick="address_add_action_s()" class="address-add-btn">添加新地址</a>
					</div>
				</div>
			</div>
		</div>
		<div class="modal fade" id="address_add_modal_s" tabindex="-1" role="dialog" aria-labelledby="address_add_modal_label_s">
			<!-- style for modal -->
			<!-- style for modal end-->
			<!-- 新增收件人地址 -->
			<div class="second-div d-w-990 z-1">
										...
										<ul style="padding-left:0px;">
											...
											<li>
												<div class="detail-ipt">
													...
													<input id="fsenderCode" name="fsenderCode" type="text" value="" placeholder="邮编">
												</div>
											</li>
										</ul>
									</div>
		...
		<!-- new sender form -->
		<form:form action="/web/service/senderSaves" modelAttribute="senderVo" method="post">
			<input type="hidden" id="username" name="username" value='${openid}' />
			<!-- sender -->
			<input type="hidden" id="senderMan" name="senderMan" value="" >
			<input type="hidden" id="senderManAddress" name="senderManAddress" value="" >
			<input type="hidden" id="senderManPhone" name="senderManPhone" value="" >
			<input type="hidden" id="senderProvince" name="senderProvince" value="" >
			<input type="hidden" id="senderCity" name="senderCity" value="" >
			<input type="hidden" id="senderCounty" name="senderCounty" value="" >
