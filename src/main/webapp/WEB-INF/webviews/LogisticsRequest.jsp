...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
								...
								<div id="cmp-div" name="cmp-div" class="form-item-content">
									...
									<div id="cmp-tg" name="cmp-tg" class="ui-select ui-select-mini" data-widget-cid="widget-8" style="z-index:99;display:none;position:absolute;margin-left:10px;">
										<ul class="ui-select-content" data-role="content" style="padding:0;margin:0;">
											<li data-role="item" class="ui-select-item ui-select-item-selected" value="ZTO"  data-disabled>中通</li>
											<li data-role="item" class="ui-select-item" alue="YTO" data-disabled>圆通</li>
											<li data-role="item" class="ui-select-item" value="SF" data-disabled>顺丰</li>
											<li data-role="item" class="ui-select-item" value="HTKY" data-disabled>汇通</li>
											<li data-role="item" class="ui-select-item" value="EMS" data-disabled>EMS</li>
										</ul>
									</div>
								</div>
								...
								<div id="spe-div" name="spe-div" class="form-item-content">
									...
									<div id="spe-tg" name="spe-tg" class="ui-select ui-select-mini" data-widget-cid="widget-8" style="z-index:99;display:none;position:absolute;margin-left:10px;">
										<ul class="ui-select-content" data-role="content" style="padding:0;margin:0;">
											...
											<li data-role="item" class="ui-select-item" value="药品" data-disabled>药品</li>
											...
											<li data-role="item" class="ui-select-item" value="服饰" data-disabled>服饰</li>
											<li data-role="item" class="ui-select-item" value="文件" data-disabled>文件</li>
											<li data-role="item" class="ui-select-item" value="贵重物品" data-disabled>贵重物品</li>
											<li data-role="item" class="ui-select-item" value="其他" data-disabled>其他</li>
										</ul>
									</div>
								</div>
							</div>
		...
		<form:form action="/web/service/logisticsSave" modelAttribute="shippingRequestVo" method="post">
			...
			<!-- receiver -->
			<!-- company -->
			<input type="hidden" id="logisticsProviderCode" name="logisticsProviderCode" value="STO" >
