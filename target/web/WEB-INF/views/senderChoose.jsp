...
<html>
	...
	<body>
		<div class="container-fluid">
			<div id="mainDiv" name="mainDiv" class="sub-row">
				<p class="sub-title">寄件人地址</p>
				${show}
			</div>
			<div class="sub-row">
				<p class="next-button">
			...
			<form:form id="toSendforChoose" action="/wechat/service/chooseSender" method="post" >
				<input type="hidden" id="selectedId" name="selectedId" value='${sid}' />
				<input type="hidden" id="openid" name="openid" value='${openid}' />
				<button type="submit" id="sbutton" name="sbutton" style="display:none"></button>
			</form:form>
			<form:form  id="toSendforSave" action="/wechat/service/senderChoose" method="post">
				<input type="hidden" id="openid" name="openid" value='${openid}' />
				<input type="hidden" id="hs" name="hs" value="0" />
		...
		<script type="text/javascript">
			...
			function deleteThis(id){
				...
				xmlHttp.open("POST","../service/senderDelete",true);
